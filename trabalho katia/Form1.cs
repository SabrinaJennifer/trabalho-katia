...
namespace trabalho_katia        //RA 6322542 Sabrina Jennifer S. Gomes
{       
    public partial class Form1 : Form
    {
        ...
        {
            MySqlConnection Conectar = new MySqlConnection("server=localhost;User Id=root;database=bdcadastro;password=6322542");
            try
            {
